...
//            BooksParticipantsUser booksParticipantsUser = new BooksParticipantsUser();
//            booksParticipantsUser.setBookId(book.getIdOfBook());
//            booksParticipantsUser.setRestaurantId(id);
//            booksParticipantsUser.setUserId(userRepo.findByUsername(SecurityContextHolder.getContext().getAuthentication().getName()).getId());
//            bookParticipantsUserRepo.save(booksParticipantsUser);
